...
-- =============================================
-- EXEC cp.[Report_SmsTraffic] @AccountUid = '619250fe-e2e5-e611-813f-06b9b96ca965', @TimeframeStart = '2017-01-23 15:00', @TimeframeEnd = '2017-08-25 15:00'
-- EXEC cp.[Report_SmsTraffic] @AccountUid = '619250fe-e2e5-e611-813f-06b9b96ca965', @TimeframeStart = '2017-07-31 16:00', @TimeframeEnd = '2017-08-14 16:00', @TimeIntervalInMins = 10080
-- EXEC cp.[Report_SmsTraffic] @AccountUid = '4EC250D4-6182-E711-8143-02D85F55FCE7', @TimeframeStart = '2018-10-03 00:00', @TimeframeEnd = '2018-10-05 00:00', @TimeIntervalInMins = 1440, @SubAccountGroupingFlag = 1, @CountryGroupingFlag = 1, @OperatorGroupingFlag = 0
CREATE PROCEDURE [cp].[Report_SmsTraffic]
...
BEGIN
	...
	BEGIN
		SELECT 
			dbo.fnTimeRountdown(MIN(sl.Date), @TimeIntervalInMins) as TimeIntervalUtc,
