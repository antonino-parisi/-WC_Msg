-- =============================================
-- Author:		Davy Jones Bolivar
-- Create date: 2019-03-14
-- Used in CP User management page
-- =============================================
-- EXEC cp.UserList_GetByAccount_v3 @AccountUid='499250FE-E2E5-E611-813F-06B9B96CA965'
-- SELECT TOP 100 * FROM cp.Account 
CREATE PROCEDURE [cp].[UserList_GetByAccount_v3]
