...
CREATE PROCEDURE [sap].[SmsLog_ExportTail_v3]
...
BEGIN
	...
	--DECLARE @LastChangedSince date = '2020-06-01'
	--DECLARE @CompanyEntity VARCHAR(10) = NULL 
	...
	FROM (
		...
		LEFT JOIN ms.AccountProductMeta AS apm ON am.AccountId = apm.AccountId AND apm.Product = 'SM'
